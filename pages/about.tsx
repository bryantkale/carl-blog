...
import Layout, { siteTitle } from "../components/DefaultLayout";
			...
			<Box>
				<Stack direction="column" spacing={2} className={utilStyles.headingMd}>
					<Typography variant="body1">
						Hi I'm Carl. I'm a fullstack web engineer residing in Boston, MA. I
						enjoy working in React, Angular, Python, and whatever else comes my
						way.
					</Typography>
					<Typography variant="body1">
